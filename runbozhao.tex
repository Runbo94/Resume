...
\programming{{C $\textbullet$ Python / 3}, { SQL $\textbullet$ \large \LaTeX $\textbullet$ \normalsize C++ $\textbullet$ C\# $\textbullet$ PHP/ 4.5}, { JS(ES6) $\textbullet$ HTML $\textbullet$ CSS $\textbullet$ NoSql $\textbullet$ Java / 6}}
...
\courses{
	\begin{itemize}
		\item \textbf{Internet Programming} \\
		A laboratory projects course. Programming models on web clients and servers. \\
		Topics include: browser and server object models, tagged languages, emphasizing HTML and XML, ASP programming, and database connectivity.\\
		\textbf{Instructor:}\\
		Jim Fawcett\\
		Edmund Yu\\
		\textbf{---------------------------------------------} A
		
		\item \textbf{Object Oriented Programming C++}
		...
		Joe Waclawski\\
		\textbf{---------------------------------------------} A
		\item \textbf{Mathematics Basis for Computing}
		\\\textbf{---------------------------------------------} A
		\item \textbf{Design and Analysis of Algorithm}
		\\\textbf{---------------------------------------------} A
		\item \textbf{Computer Architecture}
		\\\textbf{---------------------------------------------} A
		\item \textbf{Introduction to Database Management System}
		\\\textbf{---------------------------------------------} A
		\item \textbf{Randomized Algorithms: Think and Code}
		\\\textbf{---------------------------------------------} A
		\item \textbf{Structured Programming and Formal method}
		\\\textbf{---------------------------------------------} A
	\end{itemize}
}
