...
\begin{twenty}
	...
	{
		{\begin{itemize}
				\item Restaurants can make their own online menus by input their food data. Also some basic function is included like sign in, sign up, message system.
				...
				\item \textbf{Tools}: HTML5, CSS3, Bootstrap, JS, JSP, Servlet, MySQL \vspace{2mm}
		\end{itemize}}
	}
	\twentyitem
	{10/2017}
